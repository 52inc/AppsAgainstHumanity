...
class AppThemes {
  ...
  static ThemeData get light {
    ...
    return ThemeData(
      ...
      appBarTheme: AppBarTheme(color: AppColors.surfaceDark),
      snackBarTheme: SnackBarThemeData(
        backgroundColor: AppColors.surfaceLight,
        contentTextStyle: textTheme.subtitle1,
        // actionstyle: TextButton.styleFrom(
  ...
  static ThemeData get dark => ThemeData(
        ...
        appBarTheme: AppBarTheme(color: AppColors.surface),
        snackBarTheme: SnackBarThemeData(
...
extension TextAppearanceExt on BuildContext {
  TextStyle cardTextStyle(Color textColor) {
    ...
    return base.copyWith(color: textColor, fontSize: fontSize);
  }
}
